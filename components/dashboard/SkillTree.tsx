...
export function SkillTree({
  ...
  return (
    <div className="space-y-10 max-w-2xl mx-auto pb-24 animate-page-enter">
      ...
      <div className="w-full overflow-x-auto pb-8 scrollbar-thin select-none">
        <div className="space-y-12 relative min-w-[550px] md:min-w-0 px-6">
              ...
              <div key={phase.id} className="space-y-6">
                ...
                >
                      ...
                      <button
                        ...
                        className={`
                          ...
                          ${eligibility?.eligible 
                            ? 'bg-gradient-to-br from-amber-400 to-yellow-600 border-amber-800 text-text-1 animate-float-subtle shadow-[0_4px_22px_rgba(245,158,11,0.35)] hover:scale-105 active:scale-95'
                      ...
                      {activeNodeId === `chest-${phase.id}` && (
                        ...
                        >
                          ...
                          {eligibility && !eligibility.eligible && (
                            <div className="bg-surface border border-border/80 rounded-xl p-3 space-y-2 text-left text-[10px]">
                  ...
                  {[...phaseLessons].reverse().map((lesson, index) => {
                    ...
                    // Alternating pattern: Center (0%) -> Left (-22%) -> Center (0%) -> Right (22%) -> Center (0%)
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`
                            ...
                            ${status === 'completed'
                              ? 'bg-emerald-500 hover:bg-emerald-400 border-emerald-700 text-text-1 btn-3d-node-completed shadow-[0_4px_16px_rgba(16,185,129,0.25)] hover:scale-105 active:scale-95'
                              : status === 'in_progress'
                                ? 'bg-primary hover:bg-primary/95 border-blue-700 text-text-1 btn-3d-node-active animate-node-pulse shadow-[0_4px_18px_rgba(91,142,255,0.35)] hover:scale-105 active:scale-95'
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between border-t border-border/40 pt-2.5 mt-0.5">
                              ...
                              <button
                                ...
                                className="px-3.5 py-1.5 bg-primary hover:bg-primary/95 text-text-1 text-[10px] font-bold rounded-lg cursor-pointer transition-colors shadow-[0_0_8px_rgba(91,142,255,0.2)]"
                              >
